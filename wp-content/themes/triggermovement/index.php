...
<?php if(is_home()){ ?>
	...
	<div id="page-header-wrap" data-midnight="light" style="height: 650px;">	 
		<div id="page-header-bg" data-animate-in-effect="none" data-text-effect="" data-bg-pos="center" data-alignment="left" data-alignment-v="center" data-parallax="0" data-height="650" style="height: 650px; overflow: visible;">
			<div class="page-header-bg-image" style="background-image: url(/wp/wp-content/uploads/2014/04/questions.jpg);"></div> 
				<div class="container">
					<div class="row" style="top: 0px; visibility: visible; text-align: center;">
						<div class="col span_6" style="top: 163.25px;">
							<div class="inner-wrap">
								<h1 style="transform: rotateX(0deg) translate(0px, 0px); opacity: 1;"><strong>Trigger Blog</strong></h1>
								<span class="subheader" style="transform: rotateX(0deg) translate(0px, 0px); opacity: 1;"><em>Musings on Strategy, Leadership, Digital, Web Development</em></span>
							</div>	
						</div>			
					</div>
				</div>
